        ...
        <Box>
          {active ?
            <Tooltip title="Click to disconnect from wallet">
              <Button sx={theme.component.primaryButton}
                onClick={disconnect} >
                <AccountBalanceWalletIcon />
                {`${account.substring(0,
                  6)}...${account.substring(38)}`}
              </Button>
            </Tooltip> :
            <PopupState variant="popover"
              popupId="popup-select-connector">
              {popupState => <React.Fragment>
                <Tooltip title="Select one type of wallet connectors to start connecting your
wallet">
